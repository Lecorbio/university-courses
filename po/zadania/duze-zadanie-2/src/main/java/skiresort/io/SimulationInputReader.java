...
public final class SimulationInputReader {
    ...
    public static SimulationInput read(InputStream inputStream) {
        ...
        Athlete[] athletes = readAthletes(inputScanner, nodes, routes.length);
    ...
    private static Athlete[] readAthletes(
        ...
        for (int group = 0; group < groupCount; group++) {
            ...
            double boredomFactor = groupScanner.nextDouble();
            AthleteKind kind = AthleteKind.fromToken(groupScanner.next());
            boolean tracked =
            ...
            double boredomWeight = weightScanner.nextDouble();
